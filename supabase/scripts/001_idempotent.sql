-- MyChapter 001 — idempotent (부분 적용·재실행용)
-- 원본: migrations/001_initial_schema.sql
-- "type already exists" 등으로 001이 중간에 실패했을 때 SQL Editor에서 이 파일을 실행하세요.
-- 이미 있는 타입·테이블·인덱스는 건너뜁니다.
