...
|-----------|-----|------|------|
| Empty State | S-09 | ✅ | |
| 홈 (진행률·스트릭·질문) | S-10 | ✅ | Pro + projects>1 시 전체보기 |
| 프로젝트 목록 (Pro) | S-10b | ✅ | `ProjectsListPage.tsx` |
| 알림 목록 | S-11 | ✅ | |
| 모드 선택 | S-12 | ✅ | |
| 질문 모드 + draft | S-13 | ✅ | |
...
| PDF 출판 (Pro) | — | 🔄 | `generate-pdf` Edge 연동, **배포·006 SQL 필요** |
| `generate-pdf` Edge Function | — | ✅ | pdf-lib, Storage `published-pdfs` |
| 챕터 드래그 재정렬 (S-17) | — | ✅ | `reorderChapters()` |
| 기록 챕터 이동 (S-32) | — | ❌ | |
...
| `delete-account` | ✅ | 🔄 | |
| `send-daily-reminder` | ✅ | 🔄 | |
| `generate-pdf` | ✅ | 🔄 | 006 Storage SQL + 배포 |
| `expand-caption` | ❌ | — | 미구현 |
